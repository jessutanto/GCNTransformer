...
from tensorflow.keras.layers import Input, Dropout, Dense, Layer, Flatten, Reshape, Lambda, LSTM, Activation, Add, BatchNormalization, LayerNormalization, GlobalAveragePooling1D
